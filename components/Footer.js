    ...
    <div className=" bg-gray-300 shadow-lg sm:h-[80px] h:[170px] text-white flex items-center justify-evenly ">
      ...
      <div className=" hidden  sm:flex flex-col items-center justify-center  ">
        <div
          ...
          className="text-[#032d60]  font-semibold sm:text-[12px] text-[12px] flex gap-1 hover:underline"
        >
      ...
      <div className="   flex flex-col items-center justify-center  ">
        ...
        <div 
          ...
          className="text-[#032d60]  font-semibold sm:text-[12px] text-[12px] flex gap-1 hover:underline sm:hidden "
        >
          Contact Us
        </div>
